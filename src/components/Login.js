...
import verificarSenha from "../js/validaSenha.js"
import { getCookie } from '../js/cookie.js';
import eyePassword from '../js/eyePassword.js'
                        ...
                        <form action={`${Config['url-server']}/register`} method="post">
                            ...
                            <div className="modal-footer border-top-0">
                                <div className="btn-group w-100" role="group">
                                    {/* {data.etapa !== 1 && (
                                        <button type="button" className="btn btn-light text-danger btn-voltar" id={`btnEtapa${data.etapa}`} data-etapa={data.etapa} onClick={() => configurarBotoesVoltar(`btnEtapa${data.etapa}`)}>
                                            Voltar
                                        </button>
                                    )} */}
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6 col-sm-12">
                                ...
                                <form action={`${Config["url-server"]}/login`} method="post" style={{ width: "20rem", display: "flex", flexDirection: "column", alignItems: "center", margin: "0 auto" }}>
                                    ...
                                    <button className="btn btn-primary btn-lg w-100 mt-3" style={{ borderRadius: "10rem" }} type="submit">Surpreenda-se</button>
                                </form>
            ...
            <Modal data={{
                ...
                body: (
                    <>
                        ...
                        <p className="text-danger" id="feedbackSenha" style={{marginTop: '-5px'}} hidden>
